...
class PointNetPlusPlus(nn.Module):
    def __init__(self, dim=None,  padding=0.1):
    ...
    def forward(self, xyz):
        ...
        return l3_points.permute(0, 2, 1), l0_points.permute(0, 2, 1)  
...
if __name__ == '__main__': 
    print(__file__)
    model = nn.DataParallel(PointNetPlusPlus()).cuda() 
    xyz = torch.rand(256, 512, 3).cuda()
    model(xyz)
