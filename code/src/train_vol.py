...
from utils.fastpc2vol import knn, local_pc_normalize 
from torch.utils.data import Dataset 
from encoder.pointnet import SimplePointnet
from encoder.pointnetpp import PointNetPlusPlus
from model.onet import DecoderCBatchNormBlk, OnetPlusPlus2
...
class train_dataset(Dataset):
    ...
    def __getitem__(self, index): 
        ...
        return g_pc, l_pc, query, voxel, occ  
...
def train_one_epoch(model, optimizer, data_loader, device, epoch):
    ...
    for step, data in enumerate(data_loader):
        ...
        pred = model(global_pc, local_pc, query, voxel)
        # print("train one epoch:", global_pc.shape, local_pc.shape, query.shape, voxel.shape, occ_gt.shape, pred.shape)
...
def main(args):
    ...
    # 实例化训练数据集
    train_data_set = train_dataset('datatest/dense/train/octree_vol/')
    ...
    # 实例化验证数据集
    val_data_set_6 = test_dataset('datatest/dense/test/octree_vol/', "6") 
    ...
    val_data_set_7 = test_dataset('dataset/dense/test/octree_vol/', "7") 
    ...
    val_data_set_8 = test_dataset('dataset/dense/test/octree_vol/', "8") 
    ...
    val_data_set_9 = test_dataset('dataset/dense/test/octree_vol/', "9") 
    ...
    val_data_set_10 = test_dataset('dataset/dense/test/octree_vol/', "10") 
    ...
    model = OnetPlusPlus2(global_encoder, local_encoder, decoder).to(device) 
